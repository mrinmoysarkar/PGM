...
def dataConcat(n_):
    ...
    train_set_label=[data_with_all_state[n]]#random.sample(data_with_all_state,n)#data_with_all_state#[16,1,6,2,5,7,17]
    print("train set label: ", train_set_label)
...
#        
#    df = df.reset_index()
#    print("total sample size ",df.shape)
#    #print(df.iloc[1])
